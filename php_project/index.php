                                ...
                                ?>
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a href="javascript:void(0)" onclick="window.location.assign('subcategory.php?id=<?php echo $data['id']; ?>');" data-toggle="collapse" data-target="#collapse<?php echo $data['id']; ?>"><?php echo $data['name']; ?></a> 
                                        </div>
